...
MAIN_RETURN_TYPE main(int argc, char *argv[]) {
  ...
  write_reg8 (0x8005b2,0x00);

  write_reg32(0x8000b8,0x608702);
  while((read_reg8(0x8000ba) & 0x01) != 0x00);

  write_reg32(0x8000b8,0x601401);
  while((read_reg8(0x8000ba) & 0x01) != 0x00);
  ...
  write_reg8(0x8000b8,0x02);
  write_reg8(0x8000b9,0x87);  
  write_reg8(0x8000ba,0x60);
  while((read_reg8(0x8000ba) & 0x01) != 0x00); 
  
	
  write_reg8(0x8000b8,0x01);
  write_reg8(0x8000b9,0x14);  
  write_reg8(0x8000ba,0x60);
  while((read_reg8(0x8000ba) & 0x01) != 0x00); 
