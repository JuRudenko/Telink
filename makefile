...
flash: $(BIN_FILE)
	@python $(UTILS_PATH)/TlsrComProg.py -p$(DOWNLOAD_PORT)  -f  $(UTILS_PATH)/floader.bin we 0 $(BIN_FILE)
#	@python $(UTILS_PATH)/TlsrPgm.py -p$(DOWNLOAD_PORT) -t50 -a2550 -m -w we 0 $(BIN_FILE)

reset:
	@python $(UTILS_PATH)/TlsrPgm.py -p$(DOWNLOAD_PORT) -t50 -a2550 -m -w i

stop:
	@python $(UTILS_PATH)/TlsrPgm.py -p$(DOWNLOAD_PORT) -t50 -a2550 i

go:
	@python $(UTILS_PATH)/TlsrPgm.py -p$(DOWNLOAD_PORT) -w -m
	
erase-flash:
	@python $(UTILS_PATH)/TlsrComProg.py -p$(DOWNLOAD_PORT) -f $(UTILS_PATH)/floader.bin ea
#	@python $(UTILS_PATH)/TlsrPgm.py -p$(DOWNLOAD_PORT) -t50 -a2550 ea
